...
import { Selesai } from './SelesaiTableTable';

interface DeleteSelesaiProps {
    selesai: Selesai;
    onDelete: (id: number) => void;
}

const DeleteSelesai: React.FC<DeleteSelesaiProps> = ({ selesai, onDelete }) => {
