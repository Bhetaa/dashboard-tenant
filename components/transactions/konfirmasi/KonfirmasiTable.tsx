...
import ConfirmTransaction from './KonfirmasiTransaksi'
...
const KonfirmasiTable: React.FC = () => {
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr>
                            ...
                            <th className="bg-black px-4 py-2 text-right text-white">Bukti Pembayaran</th>
                    ...
                    <tbody>
                        {currentEntries.map((transaction, index) => (
                            <tr key={transaction.id} className="border-b">
                                ...
                                <td className="p-2 text-center">
                                <ConfirmTransaction confirm={ConfirmTransaction} onConfirm={handleConfirm} />
                                </td>
                            </tr>
                        ))}
                    </tbody>
