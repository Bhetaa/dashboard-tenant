...
interface DeletePembaayaranProps {
    payments: PembayaranTable;
    onDelete: (id: number) => void;
}

const DeletePembayaran: React.FC<DeletePembaayaranProps> = ({ payments, onDelete }) => {
    const [showModal, setShowModal] = useState(false);

    const handleDelete = () => {
        onDelete(payments.id);
        setShowModal(false);
    };
...
export default DeletePembayaran;